...
const weekCardUp = (week) => {
  ...
  weekSlide.style.backgroundImage =
    "url('img/theLongQuest" + currentWeek + ".jpg')";
  questArray[0].week += 1;
  nextMarketText();
};
...
var player1DamageAttackRoll = document.getElementById(
...
function player1previousCharacter() {
  ...
  player1CharCard.style.backgroundImage =
    "url('img/charCard" + player1.currentCharCard + ".jpg')";
}
...
function discardWeaponR() {
  if (player1.weapon1Card != 0) {
    discardPreview.style.backgroundImage =
      "url('img/market/w" + player1.weapon1Card + ".jpg')";
    clearDiscardPopUp();
    confirmDiscardOpen();
...
function discardWeaponL() {
  if (player1.weapon2Card != 0) {
    discardPreview.style.backgroundImage =
      "url('img/market/w" + player1.weapon2Card + ".jpg')";
    clearDiscardPopUp();
    confirmDiscardOpen();
...
function discardArmor() {
  if (player1.armorCard != 0) {
    discardPreview.style.backgroundImage =
      "url('img/market/a" + player1.armorCard + ".jpg')";
    clearDiscardPopUp();
    confirmDiscardOpen();
...
function discardHealth() {
  if (player1.healthCard != 0) {
    discardPreview.style.backgroundImage =
      "url('img/market/healthBonus0" + player1.healthCard + ".jpg')";
    clearDiscardPopUp();
    confirmDiscardOpen();
...
function discardDamage() {
  if (player1.damageCard != 0) {
    discardPreview.style.backgroundImage =
      "url('img/market/damageBonus" + player1.damageCard + ".jpg')";
    clearDiscardPopUp();
    confirmDiscardOpen();
...
function discardAttack() {
  if (player1.attackCard != 0) {
    discardPreview.style.backgroundImage =
      "url('img/market/attackBonus" + player1.attackCard + ".jpg')";
    clearDiscardPopUp();
    confirmDiscardOpen();
...
function discardDefense() {
  if (player1.defenseCard != 0) {
    discardPreview.style.backgroundImage =
      "url('img/market/defenseBonus" + player1.defenseCard + ".jpg')";
    clearDiscardPopUp();
    confirmDiscardOpen();
...
const updateBuyPreviewDualWield = () =>
  (buyPreview.style.backgroundImage =
    "url('img/market/w" + shoppingCartRightHand.weapon1Card + ".jpg')");
const updateBuyPreviewTwoHanded = () =>
  (buyPreview.style.backgroundImage =
    "url('img/market/w" + shoppingTwoHanded.weapon1Card + ".jpg')");
const updateBuyPreviewArmor = () =>
  (buyPreview.style.backgroundImage =
    "url('img/market/a" + shoppingArmor.armorCard + ".jpg')");
const updateBuyPreviewHealth = () =>
  (buyPreview.style.backgroundImage =
    "url('img/market/healthBonus0" + shoppingHealth.healthCard + ".jpg')");
const updateBuyPreviewDamage = () =>
  (buyPreview.style.backgroundImage =
    "url('img/market/damageBonus" + shoppingDamage.damageCard + ".jpg')");
const updateBuyPreviewAttack = () =>
  (buyPreview.style.backgroundImage =
    "url('img/market/attackBonus" + shoppingAttack.attackCard + ".jpg')");
const updateBuyPreviewDefense = () =>
  (buyPreview.style.backgroundImage =
    "url('img/market/defenseBonus" + shoppingDefense.defenseCard + ".jpg')");
...
function refresh() {
  ...
  player1CharCard.style.backgroundImage =
    "url('img/charCard" + player1.currentCharCard + ".jpg')";
  player1Weapon1Card.style.backgroundImage =
    "url('img/market/w" + player1.weapon1Card + ".jpg')";
  player1ArmorCard.style.backgroundImage =
    "url('img/market/a" + player1.armorCard + ".jpg')";
  player1Weapon2Card.style.backgroundImage =
    "url('img/market/w" + player1.weapon2Card + ".jpg')";
  player1HealthCard.style.backgroundImage =
    "url('img/market/healthBonus0" + player1.healthCard + ".jpg')";
  player1DamageCard.style.backgroundImage =
    "url('img/market/damageBonus" + player1.damageCard + ".jpg')";
  player1AttackCard.style.backgroundImage =
    "url('img/market/attackBonus" + player1.attackCard + ".jpg')";
  player1DefenseCard.style.backgroundImage =
    "url('img/market/defenseBonus" + player1.defenseCard + ".jpg')";
  ...
  document.getElementById(
    "okBuyRightButton"
  ).innerHTML = `<div>buy and replace <div/><br> <img src="img/market/w${player1.weapon1Card}.jpg" alt="" style="width: 80px">`;
  document.getElementById(
    "okBuyLeftButton"
  ).innerHTML = `<div>buy and replace <div/><br> <img src="img/market/w${player1.weapon2Card}.jpg" alt="" style="width: 80px">`;
  document.getElementById(
    "okBuyTwoHanded"
  ).innerHTML = `<div>buy and replace <div/><br> <img src="img/market/w${player1.weapon1Card}.jpg" alt="" style="width: 80px"><img src="img/market/w${player1.weapon2Card}.jpg" alt="" style="width: 80px">`;
  document.getElementById(
    "okBuyArmor"
  ).innerHTML = `<div>buy and replace <div/><br> <img src="img/market/a${player1.armorCard}.jpg" alt="" style="width: 80px">`;

  document.getElementById(
    "okBuyHealth"
  ).innerHTML = `<div>buy and replace <div/><br> <img src="img/market/healthBonus0${player1.healthCard}.jpg" alt="" style="width: 80px">`;
  document.getElementById(
    "okBuyDamage"
  ).innerHTML = `<div>buy and replace <div/><br> <img src="img/market/damageBonus${player1.damageCard}.jpg" alt="" style="width: 80px">`;
  document.getElementById(
    "okBuyAttack"
  ).innerHTML = `<div>buy and replace <div/><br> <img src="img/market/attackBonus${player1.attackCard}.jpg" alt="" style="width: 80px">`;
  document.getElementById(
    "okBuyDefense"
  ).innerHTML = `<div>buy and replace <div/><br> <img src="img/market/defenseBonus${player1.defenseCard}.jpg" alt="" style="width: 80px">`;

  // Damage popup images

  logWeapon1PopUp.style.backgroundImage =
    "url('img/market/w" + player1.weapon1Card + ".jpg')";
  logWeapon2PopUp.style.backgroundImage =
    "url('img/market/w" + player1.weapon2Card + ".jpg')";
...
const newEnemyApproaches = (enemyCode) => {
  ...
  enemy1CharCard.style.backgroundImage =
    "url('img/enemyCard" + currentEnemyCard + ".jpg')";
};
...
function changeEnemy() {
  ...
  enemy1CharCard.style.backgroundImage =
    "url('../Last-Man-Standing-Mini-GameLast-Man-Standing-Mini-Game/img/enemyCard" +
    currentEnemyCard +
    ".jpg')";
}
...
function player1AttackRoll() {
  ...
  if (
    ...
    player1DamageAttackRoll.innerHTML =
      "Attack total is " +
      (attackRoll + player1.attack) +
      "  (" +
      attackRoll +
...
function player1Damage() {
  ...
  if (enemyArray[currentEnemyCard].currentHealth <= 0) {
    ...
    damageRollResultK.innerHTML =
      "A quick attack inflicts " +
      attackDamage +
      " (weapons) + " +
      player1.damage +
      " (bonus)";
    damageResultLine2K.innerHTML = "oh the Blood!!";
    damageResultLine3K.innerHTML =
      "Sweet Victory!  " +
      (attackDamage + player1.damage) +
...
function player1Critical() {
  ...
  enemyArray[currentEnemyCard].currentHealth =
    enemyArray[currentEnemyCard].currentHealth - player1.damage;
  logSlideRollResult.innerHTML =
    "Your attack deals " + attackDamage / 2 + " (weapons)";
  logSlideResultLine2.innerHTML =
    'Critical hit <span style="color: red">DOUBLES </span>damage to ' +
    attackDamage +
    ", (+ " +
    player1.damage +
    " bonus)";
  logSlideResultLine3.innerHTML =
    "The enemy is crippled by " +
    (attackDamage + player1.damage) +
    " down to " +
    enemyArray[currentEnemyCard].currentHealth +
    " health";
  ...
  if (enemyArray[currentEnemyCard].currentHealth <= 0) {
    ...
    damageResultLine2K.innerHTML =
      'GLORY! Critical hit <span style="color: red">DOUBLES</span> damage to ' +
      attackDamage +
      ", (+ " +
      player1.damage +
      " bonus)";
    damageResultLine3K.innerHTML =
      "Your blow inflicts " +
      (attackDamage + player1.damage) +
      ' and <span style="color: red">kills</span> the enemy';
    enemy1Dead();
...
function enemyAttack() {
  ...
  // attackRollE = 20;
  logSlideRollResultE.innerHTML =
    "Enemy attack roll is " +
    attackRollE +
    " + " +
    enemyArray[currentEnemyCard].attack +
    " (skill)";
  ...
  if (
    ...
    logSlideResultLine3E.innerHTML =
      "You  got hit " +
      (attackDamageE + enemyArray[currentEnemyCard].damage) +
      " down to " +
      player1.currentHealth;
    ...
    logSlideResultLine3E.innerHTML =
      ...
      attackDamageE +
      " + " +
      enemyArray[currentEnemyCard].damage +
      ", down to " +
      player1.currentHealth;
  ...
  if (player1.currentHealth <= 0 && attackRollE != 20) {
    ...
    alert(
      "Oh snap! You got Rocked with a critical hit of (" +
        attackDamageE / 2 +
        " x 2)=" +
        attackDamageE +
        " + " +
        enemyArray[currentEnemyCard].damage +
        " and died instantly.. poor luck"
    );
    player1Dead();
  }
}
